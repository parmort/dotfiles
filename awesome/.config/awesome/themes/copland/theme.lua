...
theme.fg_focus                                  = "#00988e"
theme.bg_normal                                 = "#151515"
theme.bg_focus                                  = theme.bg_normal
theme.fg_urgent                                 = "#e27373"
theme.bg_urgent                                 = theme.bg_normal
theme.border_width                              = 1
theme.border_normal                             = theme.bg_normal
theme.border_focus                              = "#00988e"
theme.taglist_fg_focus                          = "#00988e"
...
theme.mpd = lain.widget.mpd({
    settings = function()
        ...
        widget:set_markup(markup.font(theme.font, markup(blue, prefix .. title) .. artist))
    end
})
